...
<body>
    ...
    <div class="taskform">
        <form class="formtask" action="index.php?action=<?= (isset($_SESSION["userid"]) && $_SESSION["userid"] != NULL) ? "pv":"" ?><?= isset($liste) ? "editPublicList&idListe=".$liste->get_id() : "addPublicList" ?>" method="POST">
